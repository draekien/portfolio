      ...
      <div className="container mx-auto py-12 md:py-20">
        ...
        <header className="mb-16 space-y-6 max-w-2xl lg:max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-foreground leading-relaxed">
            Reusable agent skills that teach a complete workflow, not a one-off
            prompt. Built on the Agent Skills open standard, installable as
            Claude Code plugins or across 40+ other agents.
          </p>
          ...
          <div className="lg:grid lg:grid-cols-[2fr_3fr] lg:gap-12 lg:items-start">
            <div>
              ...
              <p className="text-muted-foreground mb-6 lg:mb-0 max-w-prose">
                Every skill is a <Code>SKILL.md</Code> file: YAML frontmatter
                plus a Markdown body. The frontmatter <Code>description</Code>{" "}
                is the activation contract: it loads into context every session
                and decides when the agent pulls the skill in. The body is the
...
recommendation.`}
        ...
        <section className="mb-16">
          ...
          <p className="text-muted-foreground mb-8 max-w-prose leading-relaxed">
            ...
            buckets you want. For other agents, the <Code>npx skills</Code> CLI
