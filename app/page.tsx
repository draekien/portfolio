          ...
          >
            <div className="space-y-6">
              <ProjectSummaryHeader>
                ...
                <ProjectSummaryHook>
                  I kept re-explaining the same workflows to my coding agents
                  every session. These skills capture the intent and judgment
                  once, so any agent runs them the way I would.
                </ProjectSummaryHook>
                <ProjectSummaryDescription>
                  A collection of AI agent skills built on the Agent Skills open
                  standard and organised into domain buckets: drafting,
                  engineering, productivity, and output styles. Each is a{" "}
                  <Code>SKILL.md</Code> that teaches a complete workflow.
                  Install them as Claude Code plugins, or add them to any of 40+
                  agents with the <Code>npx skills</Code> CLI.
                </ProjectSummaryDescription>
              </ProjectSummaryHeader>
