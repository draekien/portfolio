...
const MailDivider: React.FC = () => {
  return (
    <Flex as="nav" sx={styles.mailDividerContainerCss}>
      <a sx={styles.iconLinkCss} href="mailto:hello@wpei.me" target="_blank" title="Say hello to William Pei" aria-label="Email William Pei">
        <MdEmail sx={styles.iconCss} />
      </a>
      <Link href="/blog">
        <a sx={styles.iconLinkCss} title="Code With Me" aria-label="Code With Me">
