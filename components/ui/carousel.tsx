...
function Carousel({
  ...
  return (
    ...
    >
      {/* biome-ignore lint/a11y/useSemanticElements: aria-roledescription="carousel" requires role="region"; <section> doesn't support aria-roledescription */}
      <div
...
function CarouselItem({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
    <>
      {/* biome-ignore lint/a11y/useSemanticElements: role="group" required per WAI-ARIA Carousel Pattern */}
      <div
        role="group"
